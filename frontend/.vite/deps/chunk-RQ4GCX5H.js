import { Grow_default } from "./chunk-KP7B7CXM.js";
import { Portal_default } from "./chunk-H2HYIGJO.js";
import { useControlled_default, useId_default } from "./chunk-ZCK7UJ4Z.js";
import { useEventCallback_default } from "./chunk-VPYVTL2K.js";
import { useForkRef_default } from "./chunk-C6NNOL5B.js";
import { capitalize_default } from "./chunk-HQBLY6XC.js";
import { memoTheme_default } from "./chunk-CYXWSVBK.js";
import { useDefaultProps } from "./chunk-UVR2RFTK.js";
import {
  HTMLElementType,
  Timeout,
  alpha,
...
import { require_react } from "./chunk-7JZAKNLV.js";
import { __toESM } from "./chunk-2TUXWMP5.js";

// node_modules/@mui/material/BasicTooltip/BasicTooltip.js
...
function flip(_ref) {
  ...
  var placements2 = [preferredPlacement].concat(fallbackPlacements).reduce(function (
    acc,
    placement2
  ) {
    return acc.concat(
  ...
  useEnhancedEffect_default(() => {
    ...
    if (true) {
      if (
        ...
        isHTMLElement2(resolvedAnchorElement) &&
...
var Popper = React.forwardRef(function Popper2(props, forwardedRef) {
  ...
  if (containerProp) {
    ...
    container =
      resolvedAnchorEl && isHTMLElement2(resolvedAnchorEl)
...
true
  ? (Popper.propTypes = {
      ...
      anchorEl: chainPropTypes(
        ...
        (props) => {
          if (props.open) {
            ...
            if (
              resolvedAnchorEl &&
              isHTMLElement2(resolvedAnchorEl) &&
       ...
       */
      modifiers: import_prop_types.default.arrayOf(
...
var Popper3 = React2.forwardRef(function Popper4(inProps, ref) {
  ...
  const RootComponent =
    (slots == null ? void 0 : slots.root) ?? (components == null ? void 0 : components.Root);
  const otherProps = {
    anchorEl,
    container,
    disablePortal,
...
true
  ? (Popper3.propTypes = {
       ...
       * The return value will passed as the reference object of the Popper instance.
       */
      anchorEl: import_prop_types2.default.oneOfType([
        HTMLElementType,
      ...
      componentsProps: import_prop_types2.default.shape({
        root: import_prop_types2.default.oneOfType([
          import_prop_types2.default.func,
          import_prop_types2.default.object
        ])
      }),
       ...
       * so it's simply `document.body` most of the time.
       */
      container: import_prop_types2.default.oneOfType([
        HTMLElementType,
        import_prop_types2.default.func
      ]),
      /**
       ...
       * To learn how to create a modifier, [read the modifiers documentation](https://popper.js.org/docs/v2/modifiers/).
       */
      modifiers: import_prop_types2.default.arrayOf(
        import_prop_types2.default.shape({
          ...
          phase: import_prop_types2.default.oneOf([
            "afterMain",
            "afterRead",
            "afterWrite",
            "beforeMain",
       ...
       * @default 'bottom'
       */
      placement: import_prop_types2.default.oneOf([
        "auto-end",
        "auto-start",
        "auto",
        "bottom-end",
...
// node_modules/@mui/material/BasicTooltip/tooltipClasses.js
...
var Tooltip = React3.forwardRef(function Tooltip2(inProps, ref) {
  ...
  const children = React3.isValidElement(childrenProp)
    ? childrenProp
  ...
  let open = openState;
  if (true) {
    const { current: isControlled } = React3.useRef(openProp !== void 0);
    React3.useEffect(() => {
      if (
        childNode &&
        childNode.disabled &&
        ...
        console.error(
          [
            "MUI: You are providing a disabled `button` child to the BasicTooltip component.",
            "A disabled element does not fire events.",
            "BasicTooltip needs to listen to the child element's events to display the title.",
            "",
  ...
  if (true) {
    ...
    React3.useEffect(() => {
      if (childNode && !childNode.getAttribute("data-mui-internal-clone-element")) {
        console.error(
          [
            "MUI: The `children` component of the BasicTooltip is not forwarding its props correctly.",
  ...
  if (true) {
    if (children.props.title) {
      console.error(
        [
          "MUI: You have provided a `title` prop to the child of <BasicTooltip />.",
  ...
  const TransitionComponent =
    slots.transition ?? components.Transition ?? TransitionComponentProp ?? Grow_default;
  ...
  const popperProps = appendOwnerState_default(
    PopperComponent,
    {
      ...PopperProps,
      ...
      className: clsx_default(
        ...
        (_a = slotProps.popper ?? componentsProps.popper) == null ? void 0 : _a.className
      )
    },
    ownerState
  );
  const transitionProps = appendOwnerState_default(
    TransitionComponent,
    {
      ...TransitionProps,
  ...
  const tooltipProps = appendOwnerState_default(
    TooltipComponent,
    {
      ...(slotProps.tooltip ?? componentsProps.tooltip),
      className: clsx_default(
        classes.tooltip,
        (_b = slotProps.tooltip ?? componentsProps.tooltip) == null ? void 0 : _b.className
      )
    },
    ownerState
  );
  const tooltipArrowProps = appendOwnerState_default(
    ArrowComponent,
    {
      ...(slotProps.arrow ?? componentsProps.arrow),
      className: clsx_default(
        classes.arrow,
        (_c = slotProps.arrow ?? componentsProps.arrow) == null ? void 0 : _c.className
      )
    },
    ownerState
  );
  return (0, import_jsx_runtime3.jsxs)(React3.Fragment, {
    children: [
      React3.cloneElement(children, childrenProps),
      (0, import_jsx_runtime3.jsx)(PopperComponent, {
          ...
          (0, import_jsx_runtime3.jsx)(TransitionComponent, {
            ...
            children: (0, import_jsx_runtime3.jsxs)(TooltipComponent, {
              ...
              children: [
                title,
                arrow2
                  ? (0, import_jsx_runtime3.jsx)(ArrowComponent, {
                      ...tooltipArrowProps,
                      ref: setArrowRef
                    })
                  : null
...
true
  ? (Tooltip.propTypes = {
      ...
      /**
       * BasicTooltip reference element.
       */
      ...
      /**
       * BasicTooltip placement.
       * @default 'bottom'
       */
      placement: import_prop_types3.default.oneOf([
        "bottom-end",
        "bottom-start",
        "bottom",
        "left-end",
      ...
      /**
       * BasicTooltip title. Zero-length titles string, undefined, null and false are never displayed.
       */
...
//# sourceMappingURL=chunk-RQ4GCX5H.js.map
